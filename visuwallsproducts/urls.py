...
urlpatterns = [
    ...
    path('api/demage_products/', DamagedProductListView.as_view(), name='repairing-product-list'),
    ...
    path('api/create_booking_all/', create_multiple_booking_requests, name='create_multiple_booking_requests'),
    path('api/productsfilter/v2/<int:user_id>/<str:category>/', filter_products_by_category_client, name='filter_products_by_category'),
    path('api/update_product_image/<int:product_id>/', update_product_image, name='update_product_image'),
    path('api/confirm_bookings_for_specific_user/<int:user_id>/', get_confirm_bookings_for_user, name='get_confirm_bookings_for_user'),
    path('api/confirm_booking_status_client/<int:booking_request_id>/', update_confirm_booking_status_new, name='update_confirm_booking_status'),
